...
// Default: Sepolia deployment from README.md; override via VITE_VOTING_ADDRESS in .env
export const VOTING_ADDRESS = import.meta.env.VITE_VOTING_ADDRESS || '0x0A917e204214FE1F6Fa9A9cAFdfE18B9184865d8';
