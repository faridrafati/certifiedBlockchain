...
// Default: Sepolia deployment from README.md; override via VITE_GUESSINGGAME_ADDRESS in .env
export const GUESSINGGAME_ADDRESS = import.meta.env.VITE_GUESSINGGAME_ADDRESS || '0xD2b1a870390fEDEc46a06f9870EdEDc5d8F53F84';
