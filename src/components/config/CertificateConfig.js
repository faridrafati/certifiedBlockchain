...
// Default: Sepolia deployment from README.md; override via VITE_CERTIFICATE_ADDRESS in .env
export const CERTIFICATE_ADDRESS = import.meta.env.VITE_CERTIFICATE_ADDRESS || '0xca1daC5e14Df6CE19ed3a7185250bEB8A3c895F6';
